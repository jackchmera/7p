...
Change these parameters, to configure widget style (flashvars, passed to xorAnalogClock.swf):
* clockSkin: [*.png, *.gif, *.jpg, 'empty'] (path to external image)
...
* urlWindow: ['_target','_self','_parent','_top'] (sets widget link target)
* UTCTime: [hh:mm:ss] (sets UTC time)
* timeOffset: [-x..x] (sets timezone offset in seconds)

Copyright (c) 2008-2012, XORBIN.COM website. All rights reserved.